...
{
    /// <summary>
    /// This class allows the user to create an account after multiple verifacation checks and complexity and unique checks
    /// </summary>
    public partial class frmCreateAccount : Form
    {
        ...
        /// then hides the current form and shows the login form
        /// </summary>
        ...
        private void btnCreateAccount_Click(object sender, EventArgs e)
        {
            ...
            clsSQL.Register(tbxTitle, tbxFirstName, tbxMiddleName, tbxLastName, tbxSuffix, tbxAddress,
                ...
                tbxSecondAnswer, cbThirdQuestion, tbxThirdAnswer, "Customer", "0", "0");
        ...
        /// <summary>
        /// This function simply adds  multiple textboxes to the same event handler, as well as passes 3 objects to a function to load data to them
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void tbxUsername_TextChanged(object sender, EventArgs e)
        {
            int uniqueCheck = 0;
            int complexCheck = 0;
            if (clsSQL.UsernameUnique(tbxUsername.Text))
            {
        ...
        {
            string fullPath;
            fullPath = Path.GetFullPath("Help\\CreateForm.chm");
            Help.ShowHelp(this, hlpCreate.HelpNamespace);
            Console.WriteLine(hlpCreate.HelpNamespace);
