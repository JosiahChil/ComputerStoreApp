...
{
    /// <summary>
    /// This class handles adding new users via the managers abilities. It also checks each textbox for tthe proper validation
    /// </summary>
    public partial class frmAddNewUser : Form
    {
        ...
        {
            int position = Int32.Parse(cbPosition.Text);
            clsSQL.Register(tbxTitle, tbxFirstName, tbxMiddleName, tbxLastName, tbxSuffix, tbxAddress,
              ...
              tbxSecondAnswer, cbThirdQuestion, tbxThirdAnswer, cbPosition.Text, cbDelete.Text, cbDisable.Text);
        ...
        private void btnHelp_Click(object sender, EventArgs e)
        {
            ...
            Help.ShowHelp(this, hlpAddUser.HelpNamespace);
